sap.ui.define(["sap/ui/test/opaQunit", "./pages/AppPage", "./pages/ViewPage", "sap/ui/test/Opa5"], function (opaTest, __AppPage, __ViewPage, Opa5) {
  "use strict";
  ...
  Opa5.extendConfig({
    viewNamespace: "my.app.generatebill.view.",
    autoWait: true
  });
