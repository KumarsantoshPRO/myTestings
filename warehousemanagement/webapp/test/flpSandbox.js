		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#warehousemanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"warehousemanagement-display": {
								"semanticObject": "warehousemanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=warehousemanagement",
									"url": sap.ui.require.toUrl("warehousemanagement")
								}
							}
						}
					}
